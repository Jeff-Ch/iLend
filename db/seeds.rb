...
Lender.create(first_name: 'John', last_name: 'Doe', email: 'test@gmail.com', password: '12345678', password_confirmation: '12345678', money: 0)

History.create(lender_id: 1, money: 1000, source: "Direct Deposit", direction: "in")



Borrower.create(first_name: 'Jane', last_name: 'Doe', email: 'test2@gmail.com', password: '12345678', password_confirmation: '12345678')
...
Borrower.create(first_name: 'Jack', last_name: 'Sparrow', email: 'test3@gmail.com', password: '12345678', password_confirmation: '12345678')
Request.create(purpose: 'Treasure Map', description: "Found in an antique shop", money: 600, money_raised: 600, borrower_id: 2)

Borrower.create(first_name: 'Kobe', last_name: 'Bryant', email: 'test4@gmail.com', password: '12345678', password_confirmation: '12345678')
